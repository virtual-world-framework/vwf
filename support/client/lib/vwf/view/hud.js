...
define( [ "module", "vwf/model", "vwf/utility" ], function( module, model, utility ) {
    ...
    return model.load( module, {
        ...
        satProperty: function( nodeID, propertyName, propertyValue ) {
            ...
            if ( this.state.elements[ nodeID ] ) {
                ...
                if ( node.drawProperties.hasOwnProperty( propertyName ) ) {
    ...
    function createElement( node ) {
        // id, drawFunc, width, height, visible
        var props = node.properties;
        var drawProps = node.drawProperties;
        var drawFunction = function( context, position ) { eval( node.draw ) };
        var element = new Element( node.id, drawFunction, props.width, props.height, props.visible );
        var i, keys;
        ...
        node.overlay.viewObject.add( element, props.alignH, props.alignV, props.offsetH, props.offsetV );
        return element;
    }
    ...
    Element = function( id, drawFunc, width, height, visible ) {
