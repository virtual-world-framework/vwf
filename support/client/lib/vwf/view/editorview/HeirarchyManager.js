	...
	initialize:function()
{
	...
	this.selectItem = function(name,type)
	{
		...
		if(type =='glge')
			node = HierarchyManager.findTHREEChild(_Editor.findviewnode(HierarchyManager.selectedID),name);
	...
	this.BuildGUI = function()
	{
		...
		if(this.getVWFParent())
			$('#hierarchyDisplay').append("<div id='heirarchyParent' style='font-weight:bold;white-space: nowrap;text-overflow: ellipsis;overflow:hidden'><div>&#x25B2 Parent ("+HierarchyManager.getVWFParent()+")</div></div>");
