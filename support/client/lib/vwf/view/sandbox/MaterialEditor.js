define(["vwf/view/sandbox/mapbrowser"], function ()
{
	var MaterialEditor = {};
	...
	function initialize()
	{
		window._MapBrowser = require("vwf/view/sandbox/mapbrowser").getSingleton();
		...
		$(document.head).append('<script type="text/javascript" src="vwf/view/sandbox/lib/colorpicker.js"></script>');
		this.show = function ()
		{
		...
		this.BuildGUIPhong = function()
		{
			...
			var colorswatchstyle = "margin: 5px;float:right;clear:right;background-color: #FF19E9;width: 25px;height: 25px;border: 2px solid lightgray;border-radius: 3px;display: inline-block;margin-left: 20px;vertical-align: middle;box-shadow: 2px 2px 5px,1px 1px 3px gray inset;background-image: url(vwf/view/sandbox/images/select3.png);background-position: center;";
			$('#MaterialBasicSettings').append('<div style="clear:both" />');
