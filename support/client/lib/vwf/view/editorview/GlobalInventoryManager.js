define(function ()
{
	...
	function initialize()
	{
		...
		$('#GlobalInventoryManagerCreate').button(
		{
			label: 'Create'
		});
		$('#GlobalInventoryManagerDelete').button(
		{
			label: 'Delete'
		});
		$('#GlobalInventoryManagerView').button(
		{
			label: 'View'
		});
		$('#GlobalInventoryManagerRename').button(
		{
			label: 'Rename'
		});
		...
		$('#ginventoryclose').click(function ()
		{
		...
		this.Take = function (id)
		{
			...
			{
				_GlobalInventoryManager.selectItem(name, 'object');
			}, 450);
			if (!_GlobalInventoryManager.isOpen()) _GlobalInventoryManager.show();
		}
		...
		$('#GlobalInventoryManagerMessage').dialog(
		{
		...
		this.offClicked = function ()
		{
			...
			if (_GlobalInventoryManager.inRename)
			{
				...
				else _Notifier.alert('Only the owner of this object may rename it in the global inventory');
			}
		}
		...
		this.itemClicked = function ()
		{
			if (_GlobalInventoryManager.inRename)
			{
				...
				else _Notifier.alert('Only the owner of this object may remove it from the global inventory');
			}
			$('#InventoryRename').hide();
