self.init = function(data)
{
  if(!self.THREE)
  {
	...
	this.SimplexNoise = new SimplexNoise(this.Random(12312).random);




this.generateTerrainSimWorker = function(datain)
{
	var vertices = [];
	var normals = [];
	var everyOtherZ = [];
	var everyOtherNormal = [];
	...
	var ret = 
	{
		"vertices" : vertices,
		"normals" : normals,
		"everyOtherZ" : everyOtherZ,
		"everyOtherNormal" : everyOtherNormal
	};	
	return ret;		
}
...
self.generateTerrain = function(terraindata,id)
{
    	
	var data = self.generateTerrainSimWorker(terraindata);
...
self.addEventListener('message', function(e) {
  ...
  if(self[command])
	self[command](e.data.data,e.data.id);
