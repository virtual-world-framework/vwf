...
if [ "$UNAME" = "Darwin" ] ; then
	...
	if type sudo >/dev/null 2>&1; then
		...
		sudo apt-get -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" install g++ curl libssl-dev apache2-utils
		sudo apt-get -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" install git-core
