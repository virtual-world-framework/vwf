define(function ()
{
	...
	function initialize()
	{
		...
		$(document.body).append('<div id="Logon">' + '	<form id="loginForm">' + '      <input type="text" placeholder="username" tabindex="300" id="profilenames" style="font-size: 1.6em;width: 90%;height: 22px;padding: 0px;margin-right: 16px;border-radius: 3px;" pop_up_selection="0"> </input>' + '      <input type="password" placeholder="password" tabindex="301"  id="password" style="font-size: 1.6em;width:90%;padding:0px;border-radius: 3px;" pop_up_selection="0"> </input>' +
		...
		$("#CreateUserProfiletable").append("<tr><td><div>Avatar</div></td><td style='width: auto;width:70%;max-width: 100%;'><select size='3' style='border-radius: 2px;width: 100%;' type='text' id='SetProfileAvatar'>" + "<option value='usmale.dae'>US Soldier 1</choice>" + "<option value='usmale2.dae'>US Soldier 2</choice>" + "<option value='afganman.dae'>Afghani Man</choice>" + "</select></td></tr>");
