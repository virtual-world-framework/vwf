...
git clone --branch development --recursive http://www.github.com/virtual-world-framework/vwf vwf

git clone --branch development  --recursive http://www.github.com/virtual-world-framework/vwf vwfsource
