...
define(function ()
{
	...
	function initialize()
	{
		...
		$(document.body).append('<script src="../vwf/view/sandbox/ace/src-min-noconflict/ace.js" type="text/javascript" charset="utf-8"></script>');
		...
		$('#maximizescripteditor').click(function ()
		{
			if (!$('#ScriptEditor').attr('maximized'))
			{
				...
				$('#maximizescripteditor').attr('src', 'vwf/view/sandbox/images/icons/window.png');
			}
			else
			{
				...
				$('#maximizescripteditor').attr('src', 'vwf/view/sandbox/images/icons/up2.png');
		...
		this.setSelectedMethod_internal = function (name, text)
		{
			...
			$('#methodtext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/stripe.png) 100% 100% repeat');
		...
		this.setSelectedProperty_internal = function (name, text)
		{
			...
			//$('#methodtextback').text(_ScriptEditor.formatScript(indentedtext));
			$('#propertytext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/stripe.png) 100% 100% repeat');
		...
		this.setSelectedEvent_internal = function (name, text)
		{
			...
			$('#eventtext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/stripe.png) 100% 100% repeat');
		...
		this.BuildGUI = function (refresh)
		{
			...
			if (!refresh)
			{
				...
				$('#eventtext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/ui-bg_diagonals-thick_8_cccccc_40x40.png) 50% 50% repeat');
				$('#methodtext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/ui-bg_diagonals-thick_8_cccccc_40x40.png) 50% 50% repeat');
				$('#propertytext').find(".ace_content").css('background', 'url(vwf/view/sandbox/images/ui-bg_diagonals-thick_8_cccccc_40x40.png) 50% 50% repeat');
