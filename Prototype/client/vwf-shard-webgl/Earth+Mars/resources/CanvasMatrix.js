...
CanvasMatrix4.prototype.load = function () {
    if (arguments.length == 1 && typeof arguments[0] == 'object') {
        var matrix = arguments[0]; if ("length" in matrix && matrix.length == 16) {
            this.m11 = matrix[0];
            this.m12 = matrix[1];
            this.m13 = matrix[2];
            this.m14 = matrix[3];
...
CanvasMatrix4.prototype.transpose = function () {
    var tmp = this.m12; this.m12 = this.m21; this.m21 = tmp;
    tmp = this.m13; this.m13 = this.m31; this.m31 = tmp;
    tmp = this.m14; this.m14 = this.m41; this.m41 = tmp;
    tmp = this.m23; this.m23 = this.m32; this.m32 = tmp;
    tmp = this.m24; this.m24 = this.m42; this.m42 = tmp; 
    tmp = this.m34; this.m34 = this.m43; this.m43 = tmp
};
...
CanvasMatrix4.prototype.translate = function (x, y, z) {
    ...
    matrix.m41 = x; matrix.m42 = y; matrix.m43 = z;
...
CanvasMatrix4.prototype.multRight = function (mat) {
 ...
 CanvasMatrix4.prototype.ortho = function (left, right, bottom, top, near, far) {
     ...
     matrix.m12 = 0; matrix.m13 = 0;
     matrix.m14 = 0; matrix.m21 = 0;
 ...
 CanvasMatrix4.prototype.perspective = function (fovy, aspect, zNear, zFar) {
     ...
     var bottom = -top; var left = aspect * bottom;
