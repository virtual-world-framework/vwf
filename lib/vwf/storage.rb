...
class VWF::Storage
  ...
  # ruby hash)
  def instance_metadata( public_path, application, instance )
    @storage_implementation.instance_metadata( public_path, application, instance )
  end
  ...
  def persistence_state( public_path, application, instance )
    @storage_implementation.persistence_state( public_path, application, instance )
  end
  ...
  def instance_save_states( public_path, application, instance )
    @storage_implementation.instance_save_states( public_path, application, instance )
  end
  ...
  def application_save_states( public_path, application )
    @storage_implementation.application_save_states( public_path, application )
  end
  ...
  def save_metadata( public_path, application, instance, save_name )
    @storage_implementation.save_metadata( public_path, application, instance, save_name )
  end
  ...
  def retrieve_save_state( public_path, application, instance, save_name )
    @storage_implementation.retrieve_save_state( public_path, application, instance, save_name )
  end
  ...
  def save_state( public_path, application, instance, save_name, save_state, metadata )
    @storage_implementation.save_state( public_path, application, instance, save_name, save_state, metadata )
  end
