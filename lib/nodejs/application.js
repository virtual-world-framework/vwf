...
function Serve( request, response, parsedRequest ) {
    ...
    if ( servehandler.File( request, response, helpers.JoinPath( "./support/client/lib/", fileName ) ) ) {
        return true;
    }
    ...
    if ( servehandler.File( request, response, helpers.JoinPath( "./public/", parsedRequest[ 'public_path' ], parsedRequest[ 'private_path' ] ) ) ) {
        return true;
    }
    ...
    if ( servehandler.Component( request, response, helpers.JoinPath( "./public/", parsedRequest[ 'public_path' ], parsedRequest[ 'private_path' ] ) ) ) {
        return true;
    }
