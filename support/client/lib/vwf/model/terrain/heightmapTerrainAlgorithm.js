...
{	
	...
	this.getTexture = function(url)
	{
		...
		{
			this.textureCache[url] = THREE.ImageUtils.loadTexture(url,THREE.UVMapping);
	...
	this.getMaterialUniforms = function(mesh,matrix)
	{
		...
		diffuseSampler:   { type: "t", value: this.getTexture( this.diffuseUrl) },
		baseSampler:   { type: "t", value:this.getTexture( this.baseUrl || "terrain/ground.jpg" ) },
		gSampler:   { type: "t", value: this.getTexture( this.gUrl ||"terrain/cliff.jpg" ) },
		rSampler:   { type: "t", value: this.getTexture( this.rUrl ||"terrain/cliff.jpg" ) },
		bSampler:   { type: "t", value: this.getTexture( this.bUrl ||"terrain/ground.jpg" ) },

		baseNormalMap:   { type: "t", value: this.getTexture( this.baseUrlNorm ||"terrain/3091-normal.jpg" ) },
		gNormalMap:   { type: "t", value: this.getTexture( this.gUrlNorm ||"terrain/grassnorm.jpg" ) },
		rNormalMap:   { type: "t", value: this.getTexture( this.rUrlNorm ||"terrain/4979-normal.jpg" ) },
		bNormalMap:   { type: "t", value: this.getTexture( this.bUrlNorm ||"textures/waternormal.jpg" ) },
		
		mixMap:   { type: "t", value: this.getTexture( this.mixUrl || "terrain/rivermix.png" ) },
